...
const attendanceStatistics = resolve => require(['@/pages/attendanceStatistics'], resolve)
...
const interestedClient = resolve => require(['@/pages/home/interestedClient'], resolve)
...
const auditSuggestion = resolve => require(['@/pages/oa/auditSuggestion'], resolve)
const attendanceCard = resolve => require(['@/pages/oa/attendanceCard'], resolve)
const attendanceGroup = resolve => require(['@/pages/oa/attendanceGroup'], resolve)
const addAttendanceGroup = resolve => require(['@/pages/oa/addAttendancePage'], resolve)
const selectedApartment = resolve => require(['@/pages/oa/selectedApartment'], resolve)
const unselectApartment = resolve => require(['@/pages/oa/unselectApartment'], resolve)
const attendanceMember = resolve => require(['@/pages/oa/attendanceMember'], resolve)
const attendanceLeader = resolve => require(['@/pages/oa/attendanceLeader'], resolve)
const apartmentMember = resolve => require(['@/pages/oa/apartmentMember'], resolve)
const attendanceApartment = resolve => require(['@/pages/oa/attendanceApartment'], resolve)
const staffManagement = resolve => require(['@/pages/oa/staffManagement'], resolve)
...
const selectApartment = resolve => require(['@/pages/oa/selectApartment'], resolve)
...
const agencyProduct = resolve => require(['@/pages/home/agencyProduct'], resolve)
const personList = resolve => require(['@/pages/oa/personList'], resolve)
const techDepartment = resolve => require(['@/pages/oa/techDepartment'], resolve)
const serviceDepartment = resolve => require(['@/pages/oa/serviceDepartment'], resolve)
...
const selectApprover = resolve => require(['@/pages/oa/selectApprover'], resolve)
const selectSendTo = resolve => require(['@/pages/oa/selectSendTo'], resolve)
const daylyselectApprover = resolve => require(['@/pages/oa/daylyselectApprover'], resolve)
const daylyselectSendTo = resolve => require(['@/pages/oa/daylyselectSendTo'], resolve)
const selectApproverOut = resolve => require(['@/pages/oa/selectApproverOut'], resolve)
const selectSendToOut = resolve => require(['@/pages/oa/selectSendToOut'], resolve)
const selectApproverOvertime = resolve => require(['@/pages/oa/selectApproverOvertime'], resolve)
const selectSendToOvertime = resolve => require(['@/pages/oa/selectSendToOvertime'], resolve)
const selectDepartmentPerson = resolve => require(['@/pages/oa/selectDepartmentPerson'], resolve)
const personnelweekly = resolve => require(['@/pages/oa/personnelweekly'], resolve)
const personnelmonthly = resolve => require(['@/pages/oa/personnelmonthly'], resolve)
const departmentmonthly = resolve => require(['@/pages/oa/departmentmonthly'], resolve)
const departmentweekly = resolve => require(['@/pages/oa/departmentweekly'], resolve)
const personnelperformence = resolve => require(['@/pages/oa/personnelperformence'], resolve)
const myAuditHistory = resolve => require(['@/pages/oa/myAuditHistory'], resolve)
const auditDetail = resolve => require(['@/pages/oa/auditDetail'], resolve)
const departmentperformence = resolve => require(['@/pages/oa/departmentperformence'], resolve)
Vue.use(Router)
